...
from feature_match.common_f import get_rays_from_uv, ray_to_3D, proj_3D_2D, img_pre, proj_3D_2D_cur, render_surface_color, save_img
...
class CoSLAM():
    ...
    def tracking_render(self, batch, frame_id, gt_color_prev, gt_depth_prev, i_prev, j_prev, i_cur, j_cur, 
                        gt_depth_prev_batch_sift, gt_depth_batch_sift, gt_color_c, gt_depth, gt_color, W1, H0, uv_cur, uv_prev, gt_color_clone):
        '''
        ...
        for i in range(self.config['tracking']['iter']):
            ...
            # # previous 2D color
            # ret_own_prev = self.model.forward_other(rays_o_prev, rays_d_prev, gt_depth_prev_batch_sift_changed)
            # rgb_rendered_prev = ret_own_prev["rgb"].detach()


            loss_2d_color = huber_loss(rgb_rendered, gt_color_c, delta=1)
        ...
        for i, batch in tqdm(enumerate(data_loader)):
            ...
            # Tracking + Mapping
                ...
                self.tracking_render(batch, i, gt_color_prev, gt_depth_prev, i_prev, j_prev, i_cur, j_cur, 
                                     gt_depth_prev_batch_sift, gt_depth_batch_sift, colors_cur, gt_depth, gt_color, W1, H0, uv_cur, uv_prev, gt_color_clone)
