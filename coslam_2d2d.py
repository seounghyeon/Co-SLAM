...
from feature_match.common_f import get_rays_from_uv, ray_to_3D, proj_3D_2D, img_pre, proj_3D_2D_cur, render_surface_color, save_img, uv_to_ray
...
class CoSLAM():
    ...
    def tracking_render(self, batch, frame_id, gt_color_prev, gt_depth_prev, i_prev, j_prev, i_cur, j_cur, 
                        ...
                        W1, H0, uv_cur, uv_prev, gt_color_clone, gt_depth_batch_sift2, m_i, m_j):
        '''
        ...
        for i in range(self.config['tracking']['iter']):
            ...
            gt_depth_batch_sift2 = gt_depth_batch_sift2[index_uv_prev_in_cur]
            # print("gt depth bacth sifetsdsfsdfsdf ", gt_depth_batch_sift_changed.shape)
            # index_prev, index_cur,
            # print("target d ", target_d.shape)

            # current 2D color
            ret_own = self.model.forward_other(rays_o_pic, rays_d_pic, gt_depth_batch_sift2)
            ...
            loss_2d_color = huber_loss(rgb_rendered, color_cur_2D, delta=1)
        ...
        for i, batch in tqdm(enumerate(data_loader)):
            ...
            # Tracking + Mapping
                ...
                self.tracking_render(batch, i, gt_color_prev, gt_depth_prev, i_prev, j_prev, i_cur, j_cur, 
                                     gt_depth_prev_batch_sift, gt_depth_batch_sift, colors_cur, gt_depth, gt_color, W1, H0, uv_cur, uv_prev, gt_color_clone, gt_depth_batch_sift2, m_i, m_j)
